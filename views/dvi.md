...
![](views/i/dvi_spring-based_layout.png "Spring-based layout")
![](views/i/dvi_bipartite_layout.png "Bipartite layout")
...
![](views/i/dvi_datanode_matrix.png "Import data dialog")
