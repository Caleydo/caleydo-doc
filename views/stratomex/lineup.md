...
### Dataset Actions
*(De)Activate a dataset*

by *clicking* a dataset all items will be included or excluded in the current stratification ranking. A colored box in the color of the data set indicates that the dataset is currently active. *Expert Hint*: double-clicking a dataset will activate it and deactivate all the others.
...
by **double clicking** a column header the table will be sorted by this. The current sorting criteria is indicated by a tiny triangle at the top center of the column. 
