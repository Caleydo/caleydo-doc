...
Pressing Import Data will bring you to the data import process you might have encountered upon startup (see Loading Data). This allows you to add multiple datasets at the same time to Caleydo.
...
You can modify the color coding by dragging the bars at the sides of the histogram, as seen in the picture on the far right.
